...
def tts(input_text='',args=None):
    # This accepts :
    #   a dict,
    #   an audio_args named tuple
    #   or arg parse object
    if args is None:
        args = audio_args(language='en-uk',output=open('output.mp3', 'w'))
    if type(args) is dict:
        args = audio_args(
                    language=args.get('language','en-uk'),
...
if __name__ == "__main__":
    ...
    tts(input_text=input_text, args=args)
